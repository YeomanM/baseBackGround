...
import com.example.demo.constants.Error;
...
public class ResponseUtil {
    ...
    public static BaseResponse errorResponse(Error error){
        return ResponseUtil.errorResponse(error.getErrCode(),error.getErrMsg());
    }
